...
export interface L00kinInpageProviderOptions
...
/**
 * The name of the stream consumed by {@link L00kinInpageProvider}.
 */
export const L00kinInpageProviderStreamName = 'l00kin-provider';

export class L00kinInpageProvider extends AbstractStreamProvider {
   ...
   */
  public readonly _l00kin: ReturnType<
    L00kinInpageProvider['_getExperimentalApi']
  >;

  public networkVersion: string | null;

  /**
   * Indicating that this provider is a L00kin provider.
   */
  public readonly isL00kin: true;

  /**
   * @param connectionStream - A Node.js duplex stream
   * @param options - An options bag
   * @param options.jsonRpcStreamName - The name of the internal JSON-RPC stream.
   * Default: l00kin-provider
  ...
  constructor(
    ...
    {
      jsonRpcStreamName = L00kinInpageProviderStreamName,
      logger = console,
      maxEventListeners,
      shouldSendMetadata,
    }: L00kinInpageProviderOptions = {},
  ) {
    ...
    this._l00kin = this._getExperimentalApi();
   ...
   * Constructor helper.
   *
   * Gets the experimental _l00kin API as Proxy, so that we can warn consumers
  ...
  protected _getExperimentalApi() {
    return new Proxy(
      {
        /**
         * Determines if L00kin is unlocked by the user.
         *
         * @returns Promise resolving to true if L00kin is currently unlocked
         */
        isUnlocked: async () => {
   ...
   *
   * @emits L00kinInpageProvider#networkChanged
